                        ...
                        <div class="col-lg-12" style="padding-left: 0">
                            <div class="intro-message">
                                <div class="wrapper-for-zagolovok">
                                    <h1>Профессиональная разработка мобильных приложений и программного обеспечения<br /></h1>
                                    <h3>Мы создаем под ключ: мобильные приложения, интернет-магазины,<br /> ПО для бизнеса, фирменные дизайны</h3>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <form action="request_price.php" method="post" autocomplete="off" role="form">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-warning btn-lg btn-yellow">Заказать расчет стоимости</button>
                        </div>
                    </form>
                </div>
                <div class="col-lg-4">&nbsp;</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <button type="button" class="btn btn-warning btn-lg btn-yellow" id="request-call-button-2" data-toggle="modal" data-target="#requestCallModal" ><img src="img/tube.png"> Закажи звонок</button>
                    <div class="copy">
          ...
          <div class="modal-body antspro-modal">
            ...
            <div class="antspro-modal-form">
                <form action="request_call.php" method="post" autocomplete="off" role="form">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-warning warning-black btn-yellow">Заказать</button>
                        </div>
                    </form>
