    ...
    <div class="content-section-a" id="services">
        ...
        <div class="container">
            ...
            <div class="row services-list">
                ...
                <div class="clear"></div>
                <div class="col-lg-4">
                    <img src="img/webdevicon.png" alt="Веб-разработка"><h2>Веб-разработка</h2>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <img src="img/designicon.png" alt="Дизайн приложений"><h2>Дизайн приложений</h2>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 design-free-button">
                    <button type="button" class="btn btn-primary btn-lg" id="request-free-design" data-toggle="modal" data-target="#requestCallModal" ><img src="img/arr.png"> Заказать</button><br />
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <form action="request_price.php" method="post" autocomplete="off" role="form">
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-danger btn-lg">Заказать расчет стоимости</button>
                        </div>
                    </form>
                </div>
                <div class="col-lg-4">&nbsp;</div>
        ...
        <div class="container">
            ...
            <div class="row list-jobs">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="desc">
                        Система снятий показаний<br />
                        Веб-приложение для снятий показаний в сфере коммунальных услуг, внедрено в г.Тараз. Написано на Ruby on Rails
                    </div>
                </div>
                <div class="col-lg-4">
                    <h2>ССП Android</h2>
                    ...
                    <div class="desc">
                        Система снятий показаний<br />
                        Мобильное приложение для снятий показаний в сфере коммунальных услуг, внедрено в г.Тараз<br />
                    </div>
                </div>
            </div>
        </div>
